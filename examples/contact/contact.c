...
int main(int argc, char **argv)
{
	...
	while (!quit) {
		...
		if(err > 0) {
			...
			c.F3, c.cq.F3, c.FC6, c.cq.FC6, c.P7, c.cq.P7, c.T8, c.cq.T8, c.F7, c.cq.F7, c.F8, c.cq.F8, c.T7, c.cq.T7, c.P8, c.cq.P8, c.AF4, c.cq.AF4, c.F4, c.cq.F4, c.AF3, c.cq.AF3, c.O2, c.cq.O2, c.O1, c.cq.O1, c.FC5, c.cq.FC5);
			fflush(stdout);
		} else if(err == 0) {
			fprintf(stderr, "Headset Timeout...\n");
		}
